...
//     // const KAKAO_AUTH_URL = `https://kauth.kakao.com/oauth/authorize?client_id=${NAVER_CLIENT_ID}&redirect_uri=${NAVER_CALLBACK_URL}&response_type=code`;
...
//                     ref={naverRef}
//                 />
//                 <S.NaverLoginBtn to={`https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id={NAVER_CLIENT_ID}&redirect_uri={NAVER_CALLBACK_URL}`} onClick={handleNaverLogin}>
//                     <S.NaverIcon/>
//                     <S.NaverLoginTitle>
//                      네이버로 로그인하기</S.NaverLoginTitle>
//                 </S.NaverLoginBtn>
...
const Login = () => {
  ...
  const handleNaverOauthLogin = () => {
    window.location.href = `http://sayo.n-e.kr:8080/oauth2/authorization/naver`;
  };

  const handleGoogleOauthLogin = () => {
    window.location.href = `http://sayo.n-e.kr:8080/oauth2/authorization/google`;
  };

  const KAKAO_AUTH_URL = `http://sayo.n-e.kr:8080/oauth2/authorization/kakao`
