...
* */
public class LoginUserEmailResolver implements HandlerMethodArgumentResolver {

    @Override
    public boolean supportsParameter(MethodParameter parameter) {

        boolean hasLoginMemberEmailAnnotation = parameter.hasParameterAnnotation(LoginUserEmail.class);
